      ...
      <div className="container pt-17 pb-15 py-sm-17 py-xxl-20">
        <div className="row">
          <div
            ...
            data-interval="-200"
            data-delay="500">
            <h2 className="display-1 fs-56 mb-4 mt-0 mt-lg-5 ls-xs pe-xl-5 pe-xxl-0" style={{ opacity: "1" }}>
              We bring solutions to make life <span className="underline-3 style-3 yellow">easier</span>
            </h2>
            <p className="lead fs-23 lh-sm mb-7 pe-lg-5 pe-xl-5 pe-xxl-0" style={{ opacity: "1" }}>
